...
router.get('/', (req, res) => {
	// explication tuto 1 => 31:40 
	// Pokemon.find({})  recupere tous les pokemons
	// populate('type') permet de recupere tous les types de chaque pokemon en meme temps
	// then recupere les pokemon
